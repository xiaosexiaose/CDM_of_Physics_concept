...
G~C+D+F_1
'
fitdata<-lavaan::sem(modeltext,newdata)
...
G~C+F_1
'
fitdata2<-sem(modeltext2,yang_data_final)
semPaths(fitdata2,what = "col",whatLabels = "stand",layout = "tree2")
summary(fitdata2)
# model 3
modeltext3<-'
A=~A_1+A_2+A_3
...
G~C+F_1
'
fitdata3<-sem(modeltext3,yang_data_final)
semPaths(fitdata3,what = "col",whatLabels = "stand",layout = "tree2")
summary(fitdata3)
...
G~C+D+F_1
'
fitdata4<-sem(modeltext4,yang_data_final)

semPaths(fitdata4,what = "col",whatLabels = "stand",layout = "tree2")

summary(fitdata4)
```
# use SEM package to fit SEM
```{r}
sem_matrix_of_yang_data<-cor(yang_data_final)
# View(sem_matrix_of_yang_data)
model_of_sem<-specifyModel(text = '
A->A_1,gamA_1
A->A_2,gamA_2
A->A_3,gamA_3
B->B_1,gamB_1
...
sem_sempackage<-sem(model = model_of_sem,S=sem_matrix_of_yang_data,obs.variables = c("A_1","A_2","A_3","B_1","B_2","B_3","B_4","B_5","C","D","E","F_1","G"),N=453)

pathDiagram(sem_sempackage,style = "ram")
